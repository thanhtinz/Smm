...
INSERT INTO "new_Ticket" ("category", "createdAt", "id", "panelId", "priority", "publicId", "status", "subject", "updatedAt", "userId") SELECT "category", "createdAt", "id", "panelId", "priority", "publicId", "status", "subject", "updatedAt", "userId" FROM "Ticket";
DROP TABLE "Ticket";
