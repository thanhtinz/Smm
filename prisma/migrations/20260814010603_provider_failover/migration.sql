...
INSERT INTO "new_Order" ("charge", "comments", "createdAt", "delay", "expiry", "id", "interval", "link", "maxPerPost", "minPerPost", "note", "panelId", "posts", "providerOrderId", "publicId", "quantity", "remains", "runs", "serviceId", "sourceOrderId", "startCount", "status", "updatedAt", "userId") SELECT "charge", "comments", "createdAt", "delay", "expiry", "id", "interval", "link", "maxPerPost", "minPerPost", "note", "panelId", "posts", "providerOrderId", "publicId", "quantity", "remains", "runs", "serviceId", "sourceOrderId", "startCount", "status", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
...
INSERT INTO "new_Service" ("autoPrice", "averageTime", "cancel", "categoryId", "createdAt", "description", "dripfeed", "enabled", "id", "max", "min", "missingSince", "name", "panelId", "position", "providerId", "providerRate", "providerServiceId", "publicId", "rate", "refill", "sourceServiceId", "type") SELECT "autoPrice", "averageTime", "cancel", "categoryId", "createdAt", "description", "dripfeed", "enabled", "id", "max", "min", "missingSince", "name", "panelId", "position", "providerId", "providerRate", "providerServiceId", "publicId", "rate", "refill", "sourceServiceId", "type" FROM "Service";
DROP TABLE "Service";
