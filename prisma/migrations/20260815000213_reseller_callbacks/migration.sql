...
CREATE TABLE "Callback" (
    ...
    CONSTRAINT "Callback_panelId_fkey" FOREIGN KEY ("panelId") REFERENCES "Panel" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Callback_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "Callback_status_nextAttemptAt_idx" ON "Callback"("status", "nextAttemptAt");

-- CreateIndex
CREATE INDEX "Callback_userId_createdAt_idx" ON "Callback"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "Callback_panelId_idx" ON "Callback"("panelId");
