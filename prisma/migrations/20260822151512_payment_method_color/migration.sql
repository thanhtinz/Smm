...
INSERT INTO "new_PaymentMethod" ("bonusPercent", "code", "config", "currencies", "description", "driver", "enabled", "feeFixed", "feePercent", "icon", "id", "image", "maxAmount", "minAmount", "name", "panelId", "position") SELECT "bonusPercent", "code", "config", "currencies", "description", "driver", "enabled", "feeFixed", "feePercent", "icon", "id", "image", "maxAmount", "minAmount", "name", "panelId", "position" FROM "PaymentMethod";
