  ...
  const actions: Action[] = [
    ...
    },
    {
      ...
      params: [
        ...
        ["username", "Profile to watch — Subscriptions and Likes spread"],
        ["posts", "Future posts covered — Subscriptions"],
        ["old_posts", "Existing posts to spread across — Likes spread"],
        ["min", "Least per post — Subscriptions and Likes spread"],
        ["max", "Most per post — Subscriptions and Likes spread"],
