...
export default function UserMenu(props: {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div role="menu" className="card absolute right-0 z-50 mt-2 w-64 overflow-hidden p-1.5 shadow-2xl">
          ...
          <div className="py-1">
            <MenuLink href="/dashboard/profile" icon="user" label="Profile" onNavigate={() => setOpen(false)} />
            <MenuLink href="/dashboard/wallet" icon="wallet" label="Wallet" onNavigate={() => setOpen(false)} />
            <MenuLink href="/dashboard/api" icon="key" label="API key" onNavigate={() => setOpen(false)} />
            {props.role === "admin" && (
