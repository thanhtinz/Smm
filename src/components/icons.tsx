...
export const Icons = {
  ...
  cart: raw(
    <>
      ...
      <path d="M2 3h2.2l2.3 12.2a2 2 0 0 0 2 1.6h8.4a2 2 0 0 0 2-1.6L21 7H5.5" />
    </>
  ),
  ...
  key: raw(
    <>
      ...
      <path d="m10.5 11.5 8-8|M16 6l2.5 2.5|M14 8l2.5 2.5" />
    </>
  ),
  ...
  package: raw(
    <>
      ...
      <path d="m3.3 7.5 8.7 5 8.7-5|M12 21.5v-9" />
    </>
  ),
  ...
  palette: raw(
    <>
      <path d="M12 3a9 9 0 1 0 0 18c1.2 0 2-.8 2-1.8 0-.5-.2-.9-.5-1.2-.3-.3-.5-.7-.5-1.2 0-1 .9-1.8 2-1.8h1.5A4.5 4.5 0 0 0 21 10.5C21 6.4 16.9 3 12 3z" />
  ...
  gift: raw(
    <>
      ...
      <path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-7|M12 8v13" />
  ...
  database: raw(
    <>
      ...
      <path d="M4 5.5v13c0 1.7 3.6 3 8 3s8-1.3 8-3v-13|M4 12c0 1.7 3.6 3 8 3s8-1.3 8-3" />
    </>
  ),
  server: raw(
    <>
  ...
  linkedin: raw(
    <>
      ...
      <path d="M7.5 10.5V17|M7.5 7.2h.01|M11.5 17v-3.6a2.4 2.4 0 0 1 4.8 0V17" />
    </>
  ),
  spotify: raw(
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="M7.5 9.5c3-.8 6.2-.5 8.8 1|M8 13c2.4-.6 4.9-.4 7 .8|M8.8 16.2c1.9-.4 3.7-.3 5.4.6" />
    </>
  ),
  ...
  qrcode: raw(
    <>
      ...
      <path d="M14 14h3v3h-3z|M20 14h1|M14 20h1|M18 18h3v3h-3z" />
    </>
  ),
  crypto: raw(
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="M9.5 8h4a2.2 2.2 0 0 1 0 4.4h-4zM9.5 12.4h4.4a2.3 2.3 0 0 1 0 4.6H9.5zM9.5 8v9|M11.5 6v2|M11.5 17v2" />
    </>
  ),
} as const;
